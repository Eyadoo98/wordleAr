...
{{--            <button type="button" @click="showModal = true">Open Modal</button>--}}
    ...
    <div x-data="{ showModal: true }">
        ...
        <div class="fixed inset-0 z-30 flex items-center justify-center overflow-auto bg-black bg-opacity-50 custom-font-size-modal"
             x-show="showModal">
            <!-- Modal inner -->
            <div class="max-w-3xl px-6 py-4 mx-auto rounded shadow-lg  bg-white dark:bg-black"
            ...
            >
                ...
                <div class="flex flex-col">
                    <div>
                        <span class="text-black dark:text-white gray-400 border-2 border-green-500 p-2 bg-green-500 letter-example-one custom-letters">م</span>
                ...
                <div class="flex flex-col">
                    <div>
                        <span class="text-black dark:text-white  border-2 gray-400  p-2 custom-letters">ت</span>
                        <span class="text-black dark:text-white  border-2 gray-400  border-yellow-500 p-2 bg-yellow-500 letter-example-two custom-letters">ف</span>
                ...
                <div class="flex flex-col">
                    <div>
                        <span class="text-black dark:text-white  border-2 gray-400  p-2 pl-2" style="display: inline-block; width: 37px;">س</span>
                        <span class="text-black dark:text-white  border-2 gray-400  p-2 custom-letters" style="min-width: 36px; width: 37px;">ف</span>
                        <span class="text-black dark:text-white  border-2 gray-400  p-2 custom-letters" style="min-width: 36px;padding-right: 12px; width: 37px;">ي</span>
                        <span class="text-black dark:text-white  border-2 gray-400  p-2 border-gray-500 bg-gray-500 letter-example-three" style="min-width: 36px;padding-right: 12px; width: 37px;">ن</span>
                        <span class="text-black dark:text-white  border-2 gray-400  p-2 custom-letters" style="min-width: 36px;padding-right: 12px; width: 37px;">ة</span>
                    </div>
                    <div class="text-black dark:text-white mt-9">
